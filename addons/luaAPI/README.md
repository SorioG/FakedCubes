...
NOTE: Due to this [issue](https://github.com/WeaselGames/godot_luaAPI/issues/187), I have compiled the android binaries myself, You can see them in bin directory.
